...
from api_calling import note_generator,audio_generator,Quiz_question_genaretor,Quiz_answer
        ...
        # QUIZ
         with st.container(border=True):
               ...
               with st.spinner("Please wait....."):
                  ...
                  if option=="YES":
                      st.subheader("Your Quiz question answer")
                      with st.spinner("Please wait......"):
                          ANSWER=Quiz_answer(Question)
                          st.markdown(ANSWER)
                  else:
                      st.markdown("Thank you.Happy Learning")
